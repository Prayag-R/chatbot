...
export default function ChatbotDemo() {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([
        {
          role: 'assistant',
          content: "Hi! 👋 I'm here to help answer any questions about our business. What would you like to know?",
          timestamp: new Date()
        }
      ]);
    }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="bg-white rounded-2xl shadow-2xl w-90 h-[525px] flex flex-col overflow-hidden border border-transparent">
          {/* Header */}
